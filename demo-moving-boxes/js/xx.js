...
(function (xx) {
    (function (pixi) {
        (function (factory) {
            /* Create a new PIXI texture for the given image */
            function texture(image) {
                var frame = new PIXI.Rectangle(0, 0, image.width, image.height);
            ...
            /* Create a new PIXI sprite for the given image */
            function sprite(image) {
                var texture = factory.texture(image);
                var sprite = new PIXI.Sprite(texture);
                return sprite;
            }
            factory.sprite = sprite;
        })(pixi.factory || (pixi.factory = {}));
        var factory = pixi.factory;
    })(xx.pixi || (xx.pixi = {}));
    var pixi = xx.pixi;
})(xx || (xx = {}));
/// <reference path="../__init__.ts"/>
    ...
    (function (pixi) {
        (function (box2d) {
            ...
            var Body = (function () {
                ...
                * @param url The url for the background to display.
                */
                function Body(body, model, display) {
                    if (typeof model === "undefined") { model = null; }
                    if (typeof display === "undefined") { display = null; }
                    this.model = model ? model : new xx.pixi.box2d.body.Model(body, this);
                    this.display = display ? display : new xx.pixi.box2d.body.Display();
                }
...
(function (xx) {
    (function (box2d) {
        ...
        var World = (function () {
            ...
            /* Attach a box2d collision detector */
            World.prototype._loadContactWatcher = function () {
                var _this = this;
                this._listener = new Box2D.b2ContactListener();
                Box2D.customizeVTable(this._listener, [
                    {
                        ...
                        replacement: function (thsPtr, contactPtr) {
                            ...
                            if (_this._listenerCallback != null) {
                                _this._listenerCallback([bodyA, bodyB]);
                            }
                        }
                    }
                ]);
            ...
            /* Add a contact listener and invoke events when it gets called */
            World.prototype.onIntersect = function (callback) {
                if (this._listener == null) {
                    this._loadContactWatcher();
                }
            ...
            World.applyForce = function (body, force) {
                // see: http://www.iforce2d.net/b2dtut/forces
                body.ApplyForce(new Box2D.b2Vec2(force.x, force.y), body.GetWorldCenter());
            };

            /* Teleport a body to a new location */
            World.setTransform = function (body, pos, angle) {
                if (typeof pos === "undefined") { pos = null; }
                if (typeof angle === "undefined") { angle = 0; }
                var bpos = pos == null ? body.GetPosition() : new Box2D.b2Vec2(pos.x, pos.y);
                body.SetTransform(bpos, angle);
            };

            /* Apply an impluse (immediate force) to a given body */
            World.applyImpulse = function (body, force) {
                // see: http://www.iforce2d.net/b2dtut/forces
        ...
        var Textures = (function () {
            ...
            */
            ...
            Textures.prototype.texture = function () {
                return xx.pixi.factory.texture(this._image);
            };
            return Textures;
        })();
        ...
        var FrameAnimation = (function (_super) {
            ...
            */
            ...
            FrameAnimation.prototype.add = function (name, enter, active, exit, textures) {
                this.bind({
                    name: name,
                    enter: enter == null ? null : new texture_packer.FrameAnim(enter, textures),
                    active: active == null ? null : new texture_packer.FrameAnim(active, textures),
                    exit: exit == null ? null : new texture_packer.FrameAnim(exit, textures)
                });
            };
