...
declare module xx {
    module pixi {
        module factory {
            function texture(image: HTMLImageElement): any;
            function sprite(image: HTMLImageElement): any;
        }
    }
}
declare var PIXI: any;
    ...
    module pixi {
        module box2d {
            ...
            class Body implements Stagable {
                ...
                constructor(body: string, model?: body.Model, display?: body.Display);
                public attach(channel: any, stage: Stage): void;
...
declare module xx {
    module box2d {
        ...
        class World {
            ...
            constructor();
            private _loadContactWatcher();
            public onIntersect(callback: (body: any[]) => void): void;
            public createBody(block: xn.Quad, type?: BodyType, density?: number, friction?: number, restitution?: number): any;
            static applyForce(body: any, force: xn.Point): void;
            static setTransform(body: any, pos?: xn.Point, angle?: number): void;
            static applyImpulse(body: any, force: xn.Point): void;
